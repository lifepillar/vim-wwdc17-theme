...
" Last Updated: Sun Jun  2 23:08:06 2019

" Generated by Colortemplate v2.0.0b
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  if s:fc == 0
    hi StatusLine guifg=#5f5f61 guibg=#fafafa guisp=NONE gui=bold,reverse cterm=bold,reverse
    hi StatusLineNC guifg=#5f5f61 guibg=#f0f0f0 guisp=NONE gui=reverse cterm=reverse
    hi TabLine guifg=#f0f0f0 guibg=#5f5f61 guisp=NONE gui=NONE cterm=NONE
    hi TabLineFill guifg=#fafafa guibg=#5f5f61 guisp=NONE gui=NONE cterm=NONE
    hi TabLineSel guifg=#fafafa guibg=#5f5f61 guisp=NONE gui=bold cterm=bold
    hi VertSplit guifg=#f0f0f0 guibg=#5f5f61 guisp=NONE gui=NONE cterm=NONE
    hi WildMenu guifg=#fafafa guibg=#db2d45 guisp=NONE gui=bold cterm=bold
  elseif s:fc == 1
    hi StatusLine guifg=#e8503f guibg=#fafafa guisp=NONE gui=bold,reverse cterm=bold,reverse
    hi StatusLineNC guifg=#e8503f guibg=#f0f0f0 guisp=NONE gui=reverse cterm=reverse
    hi TabLine guifg=#f0f0f0 guibg=#e8503f guisp=NONE gui=NONE cterm=NONE
    hi TabLineFill guifg=#fafafa guibg=#e8503f guisp=NONE gui=NONE cterm=NONE
    hi TabLineSel guifg=#fafafa guibg=#d87900 guisp=NONE gui=bold cterm=bold
    hi VertSplit guifg=#f0f0f0 guibg=#e8503f guisp=NONE gui=NONE cterm=NONE
    hi WildMenu guifg=#fafafa guibg=#abb96e guisp=NONE gui=bold cterm=bold
  elseif s:fc == 2
    hi StatusLine guifg=#00998c guibg=#fafafa guisp=NONE gui=bold,reverse cterm=bold,reverse
    hi StatusLineNC guifg=#00998c guibg=#f0f0f0 guisp=NONE gui=reverse cterm=reverse
    hi TabLine guifg=#f0f0f0 guibg=#00998c guisp=NONE gui=NONE cterm=NONE
    hi TabLineFill guifg=#fafafa guibg=#00998c guisp=NONE gui=NONE cterm=NONE
    hi TabLineSel guifg=#fafafa guibg=#00998c guisp=NONE gui=bold cterm=bold
    hi VertSplit guifg=#f0f0f0 guibg=#00998c guisp=NONE gui=NONE cterm=NONE
    hi WildMenu guifg=#fafafa guibg=#db2d45 guisp=NONE gui=bold cterm=bold
  elseif s:fc == 3
    hi StatusLine guifg=#d87900 guibg=#fafafa guisp=NONE gui=bold,reverse cterm=bold,reverse
    hi StatusLineNC guifg=#d87900 guibg=#f0f0f0 guisp=NONE gui=reverse cterm=reverse
    hi TabLine guifg=#f0f0f0 guibg=#d87900 guisp=NONE gui=NONE cterm=NONE
    hi TabLineFill guifg=#fafafa guibg=#d87900 guisp=NONE gui=NONE cterm=NONE
    hi TabLineSel guifg=#fafafa guibg=#d87900 guisp=NONE gui=bold cterm=bold
    hi VertSplit guifg=#f0f0f0 guibg=#d87900 guisp=NONE gui=NONE cterm=NONE
    hi WildMenu guifg=#fafafa guibg=#db2d45 guisp=NONE gui=bold cterm=bold
  elseif s:fc == 4
    hi StatusLine guifg=#527f8f guibg=#fafafa guisp=NONE gui=bold,reverse cterm=bold,reverse
    hi StatusLineNC guifg=#527f8f guibg=#f0f0f0 guisp=NONE gui=reverse cterm=reverse
    hi TabLine guifg=#fafafa guibg=#527f8f guisp=NONE gui=NONE cterm=NONE
    hi TabLineFill guifg=#fafafa guibg=#527f8f guisp=NONE gui=NONE cterm=NONE
    hi TabLineSel guifg=#fafafa guibg=#527f8f guisp=NONE gui=bold cterm=bold
    hi VertSplit guifg=#f0f0f0 guibg=#527f8f guisp=NONE gui=NONE cterm=NONE
    hi WildMenu guifg=#fafafa guibg=#db2d45 guisp=NONE gui=bold cterm=bold
  elseif s:fc == 5
    hi StatusLine guifg=#db2d45 guibg=#fafafa guisp=NONE gui=bold,reverse cterm=bold,reverse
    hi StatusLineNC guifg=#db2d45 guibg=#f0f0f0 guisp=NONE gui=reverse cterm=reverse
    hi TabLine guifg=#f0f0f0 guibg=#db2d45 guisp=NONE gui=NONE cterm=NONE
    hi TabLineFill guifg=#f0f0f0 guibg=#db2d45 guisp=NONE gui=NONE cterm=NONE
    hi TabLineSel guifg=#fafafa guibg=#db2d45 guisp=NONE gui=bold cterm=bold
    hi VertSplit guifg=#f0f0f0 guibg=#db2d45 guisp=NONE gui=NONE cterm=NONE
    hi WildMenu guifg=#fafafa guibg=#d87900 guisp=NONE gui=NONE cterm=NONE
  elseif s:fc == 6
    hi StatusLine guifg=#159ccc guibg=#fafafa guisp=NONE gui=bold,reverse cterm=bold,reverse
    hi StatusLineNC guifg=#159ccc guibg=#f0f0f0 guisp=NONE gui=reverse cterm=reverse
    hi TabLine guifg=#f0f0f0 guibg=#159ccc guisp=NONE gui=NONE cterm=NONE
    hi TabLineFill guifg=#fafafa guibg=#159ccc guisp=NONE gui=NONE cterm=NONE
    hi TabLineSel guifg=#fafafa guibg=#159ccc guisp=NONE gui=bold cterm=bold
    hi VertSplit guifg=#f0f0f0 guibg=#159ccc guisp=NONE gui=NONE cterm=NONE
    hi WildMenu guifg=#fafafa guibg=#db2d45 guisp=NONE gui=bold cterm=bold
  elseif s:fc == 7
    hi StatusLine guifg=#f0f0f0 guibg=#5f5f61 guisp=NONE gui=bold,reverse cterm=bold,reverse
    hi StatusLineNC guifg=#f0f0f0 guibg=#888888 guisp=NONE gui=reverse cterm=reverse
    hi TabLine guifg=#888888 guibg=#f0f0f0 guisp=NONE gui=NONE cterm=NONE
    hi TabLineFill guifg=#5f5f61 guibg=#f0f0f0 guisp=NONE gui=NONE cterm=NONE
    hi TabLineSel guifg=#5f5f61 guibg=#f0f0f0 guisp=NONE gui=bold cterm=bold
    hi VertSplit guifg=#888888 guibg=#f0f0f0 guisp=NONE gui=NONE cterm=NONE
    hi WildMenu guifg=#fafafa guibg=#db2d45 guisp=NONE gui=bold cterm=bold
  elseif s:fc == 8
    hi StatusLine guifg=#888888 guibg=#fafafa guisp=NONE gui=bold,reverse cterm=bold,reverse
    hi StatusLineNC guifg=#888888 guibg=#f0f0f0 guisp=NONE gui=reverse cterm=reverse
    hi TabLine guifg=#f0f0f0 guibg=#888888 guisp=NONE gui=NONE cterm=NONE
    hi TabLineFill guifg=#fafafa guibg=#888888 guisp=NONE gui=NONE cterm=NONE
    hi TabLineSel guifg=#fafafa guibg=#888888 guisp=NONE gui=bold cterm=bold
    hi VertSplit guifg=#f0f0f0 guibg=#888888 guisp=NONE gui=NONE cterm=NONE
    hi WildMenu guifg=#fafafa guibg=#db2d45 guisp=NONE gui=bold cterm=bold
  elseif s:fc == 9
    hi StatusLine guifg=#d87900 guibg=#fafafa guisp=NONE gui=bold,reverse cterm=bold,reverse
    hi StatusLineNC guifg=#d87900 guibg=#f0f0f0 guisp=NONE gui=reverse cterm=reverse
  ...
  elseif s:fc == 10
    ...
    hi WildMenu guifg=#fafafa guibg=#db2d45 guisp=NONE gui=bold cterm=bold
  elseif s:fc == 11
    hi StatusLine guifg=#e1ad0b guibg=#fafafa guisp=NONE gui=bold,reverse cterm=bold,reverse
    hi StatusLineNC guifg=#e1ad0b guibg=#f0f0f0 guisp=NONE gui=reverse cterm=reverse
    hi TabLine guifg=#f0f0f0 guibg=#e1ad0b guisp=NONE gui=NONE cterm=NONE
    hi TabLineFill guifg=#fafafa guibg=#e1ad0b guisp=NONE gui=NONE cterm=NONE
    hi TabLineSel guifg=#fafafa guibg=#e1ad0b guisp=NONE gui=bold cterm=bold
    hi VertSplit guifg=#f0f0f0 guibg=#e1ad0b guisp=NONE gui=NONE cterm=NONE
    hi WildMenu guifg=#fafafa guibg=#db2d45 guisp=NONE gui=bold cterm=bold
  elseif s:fc == 12
    hi StatusLine guifg=#8c61a6 guibg=#fafafa guisp=NONE gui=bold,reverse cterm=bold,reverse
    hi StatusLineNC guifg=#8c61a6 guibg=#f0f0f0 guisp=NONE gui=reverse cterm=reverse
    hi TabLine guifg=#f0f0f0 guibg=#8c61a6 guisp=NONE gui=NONE cterm=NONE
    hi TabLineFill guifg=#fafafa guibg=#8c61a6 guisp=NONE gui=NONE cterm=NONE
    hi TabLineSel guifg=#fafafa guibg=#8c61a6 guisp=NONE gui=bold cterm=bold
    hi VertSplit guifg=#f0f0f0 guibg=#8c61a6 guisp=NONE gui=NONE cterm=NONE
    hi WildMenu guifg=#fafafa guibg=#db2d45 guisp=NONE gui=bold cterm=bold
  elseif s:fc == 13
    hi StatusLine guifg=#eb314b guibg=#fafafa guisp=NONE gui=bold,reverse cterm=bold,reverse
    hi StatusLineNC guifg=#eb314b guibg=#f0f0f0 guisp=NONE gui=reverse cterm=reverse
    hi TabLine guifg=#f0f0f0 guibg=#eb314b guisp=NONE gui=NONE cterm=NONE
    hi TabLineFill guifg=#f0f0f0 guibg=#eb314b guisp=NONE gui=NONE cterm=NONE
    hi TabLineSel guifg=#fafafa guibg=#eb314b guisp=NONE gui=bold cterm=bold
    hi VertSplit guifg=#f0f0f0 guibg=#eb314b guisp=NONE gui=NONE cterm=NONE
    hi WildMenu guifg=#fafafa guibg=#d87900 guisp=NONE gui=NONE cterm=NONE
  elseif s:fc == 14
    hi StatusLine guifg=#23bce1 guibg=#fafafa guisp=NONE gui=bold,reverse cterm=bold,reverse
    hi StatusLineNC guifg=#23bce1 guibg=#f0f0f0 guisp=NONE gui=reverse cterm=reverse
    hi TabLine guifg=#f0f0f0 guibg=#23bce1 guisp=NONE gui=NONE cterm=NONE
    hi TabLineFill guifg=#fafafa guibg=#23bce1 guisp=NONE gui=NONE cterm=NONE
    hi TabLineSel guifg=#fafafa guibg=#23bce1 guisp=NONE gui=bold cterm=bold
    hi VertSplit guifg=#f0f0f0 guibg=#23bce1 guisp=NONE gui=NONE cterm=NONE
    hi WildMenu guifg=#fafafa guibg=#db2d45 guisp=NONE gui=bold cterm=bold
  elseif s:fc == 15
    hi StatusLine guifg=#fafafa guibg=#5f5f61 guisp=NONE gui=bold,reverse cterm=bold,reverse
    hi StatusLineNC guifg=#fafafa guibg=#888888 guisp=NONE gui=reverse cterm=reverse
    hi TabLine guifg=#888888 guibg=#fafafa guisp=NONE gui=NONE cterm=NONE
    hi TabLineFill guifg=#888888 guibg=#fafafa guisp=NONE gui=NONE cterm=NONE
    hi TabLineSel guifg=#5f5f61 guibg=#fafafa guisp=NONE gui=bold cterm=bold
    hi VertSplit guifg=#888888 guibg=#fafafa guisp=NONE gui=NONE cterm=NONE
    hi WildMenu guifg=#fafafa guibg=#888888 guisp=NONE gui=NONE cterm=NONE
  endif
  unlet s:fc
  ...
  hi Ignore guifg=#fafafa guibg=NONE guisp=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 2
  ...
  hi SpellBad term=bold,italic,reverse
  hi SpellCap term=bold,italic,reverse
  hi SpellLocal term=bold,italic,reverse
  ...
  if !s:italics
    ...
    hi Folded term=NONE
    hi SpellBad term=bold,reverse
    hi SpellCap term=bold,reverse
    hi SpellLocal term=bold,reverse
...
" DiffAdd              unused unused reverse
" DiffChange           unused unused reverse
" DiffDelete           unused unused reverse
" DiffText             unused unused bold,reverse
" Directory            unused unused
" EndOfBuffer          unused unused
" ErrorMsg             unused unused bold,reverse,italic
" FoldColumn           unused unused
" Folded               unused unused italic
" IncSearch            unused unused reverse
" LineNr               unused unused reverse
" MatchParen           unused unused
...
" Question             unused unused
" Search               unused unused
" SignColumn           unused unused
" SpecialKey           unused unused
" SpellBad             unused unused reverse,bold,italic
" SpellCap             unused unused reverse,bold,italic
" SpellLocal           unused unused reverse,bold,italic
" SpellRare            unused unused underline
...
" WarningMsg           unused unused
" WildMenu             unused unused
