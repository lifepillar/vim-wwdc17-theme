...
" Last Updated: Thu Jun  7 09:24:59 2018
...
if !get(g:, 'wwdc17_use16', 0)
  ...
  elseif s:fc == 2
    hi StatusLine ctermfg=37 ctermbg=231 guifg=#00a7a0 guibg=#fafafa guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi StatusLineNC ctermfg=37 ctermbg=31 guifg=#00a7a0 guibg=#4a8091 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi TabLine ctermfg=31 ctermbg=37 guifg=#4a8091 guibg=#00a7a0 guisp=NONE cterm=NONE gui=NONE
    hi TabLineFill ctermfg=231 ctermbg=37 guifg=#fafafa guibg=#00a7a0 guisp=NONE cterm=NONE gui=NONE
    hi TabLineSel ctermfg=231 ctermbg=37 guifg=#fafafa guibg=#00a7a0 guisp=NONE cterm=NONE gui=NONE
    hi VertSplit ctermfg=31 ctermbg=37 guifg=#4a8091 guibg=#00a7a0 guisp=NONE cterm=NONE gui=NONE
    hi WildMenu ctermfg=231 ctermbg=197 guifg=#fafafa guibg=#db2d45 guisp=NONE cterm=NONE gui=NONE
  elseif s:fc == 3
    hi StatusLine ctermfg=178 ctermbg=231 guifg=#e1ad0b guibg=#fafafa guisp=NONE cterm=NONE,bold,reverse gui=NONE,bold,reverse
    hi StatusLineNC ctermfg=178 ctermbg=31 guifg=#e1ad0b guibg=#4a8091 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi TabLine ctermfg=31 ctermbg=178 guifg=#4a8091 guibg=#e1ad0b guisp=NONE cterm=NONE gui=NONE
    ...
    hi VertSplit ctermfg=31 ctermbg=178 guifg=#4a8091 guibg=#e1ad0b guisp=NONE cterm=NONE gui=NONE
    hi WildMenu ctermfg=231 ctermbg=197 guifg=#fafafa guibg=#db2d45 guisp=NONE cterm=NONE,bold gui=NONE,bold
  elseif s:fc == 4
  ...
  elseif s:fc == 8
    ...
    hi WildMenu ctermfg=231 ctermbg=197 guifg=#fafafa guibg=#db2d45 guisp=NONE cterm=NONE,bold gui=NONE,bold
  elseif s:fc == 9
    hi StatusLine ctermfg=166 ctermbg=231 guifg=#d87b32 guibg=#fafafa guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi StatusLineNC ctermfg=166 ctermbg=31 guifg=#d87b32 guibg=#4a8091 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi TabLine ctermfg=31 ctermbg=166 guifg=#4a8091 guibg=#d87b32 guisp=NONE cterm=NONE gui=NONE
    hi TabLineFill ctermfg=231 ctermbg=166 guifg=#fafafa guibg=#d87b32 guisp=NONE cterm=NONE gui=NONE
    hi TabLineSel ctermfg=231 ctermbg=166 guifg=#fafafa guibg=#d87b32 guisp=NONE cterm=NONE gui=NONE
    hi VertSplit ctermfg=31 ctermbg=166 guifg=#4a8091 guibg=#d87b32 guisp=NONE cterm=NONE gui=NONE
    hi WildMenu ctermfg=231 ctermbg=143 guifg=#fafafa guibg=#abb96e guisp=NONE cterm=NONE gui=NONE
  elseif s:fc == 10
    hi StatusLine ctermfg=143 ctermbg=231 guifg=#abb96e guibg=#fafafa guisp=NONE cterm=NONE,bold,reverse gui=NONE,bold,reverse
    hi StatusLineNC ctermfg=143 ctermbg=59 guifg=#abb96e guibg=#5f5f61 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi TabLine ctermfg=59 ctermbg=143 guifg=#5f5f61 guibg=#abb96e guisp=NONE cterm=NONE gui=NONE
    ...
    hi VertSplit ctermfg=59 ctermbg=143 guifg=#5f5f61 guibg=#abb96e guisp=NONE cterm=NONE gui=NONE
    hi WildMenu ctermfg=231 ctermbg=197 guifg=#fafafa guibg=#db2d45 guisp=NONE cterm=NONE gui=NONE
  elseif s:fc == 11
    hi StatusLine ctermfg=178 ctermbg=231 guifg=#ebb822 guibg=#fafafa guisp=NONE cterm=NONE,bold,reverse gui=NONE,bold,reverse
    hi StatusLineNC ctermfg=178 ctermbg=31 guifg=#ebb822 guibg=#4a8091 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi TabLine ctermfg=31 ctermbg=178 guifg=#4a8091 guibg=#ebb822 guisp=NONE cterm=NONE gui=NONE
    ...
    hi VertSplit ctermfg=31 ctermbg=178 guifg=#4a8091 guibg=#ebb822 guisp=NONE cterm=NONE gui=NONE
    hi WildMenu ctermfg=231 ctermbg=197 guifg=#fafafa guibg=#db2d45 guisp=NONE cterm=NONE,bold gui=NONE,bold
  elseif s:fc == 12
...
if !has('gui_running') && get(g:, 'wwdc17_transp_bg', 0)
  hi Normal ctermfg=0 ctermbg=NONE guifg=#5f5f61 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi CursorLine ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi CursorLineNr ctermfg=9 ctermbg=NONE guifg=#d87b32 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  ...
  hi Terminal ctermfg=0 ctermbg=NONE guifg=#5f5f61 guibg=NONE guisp=NONE cterm=NONE gui=NONE
else
  hi Normal ctermfg=0 ctermbg=15 guifg=#5f5f61 guibg=#fafafa guisp=NONE cterm=NONE gui=NONE
  hi CursorLine ctermfg=NONE ctermbg=7 guifg=NONE guibg=#f0f0f0 guisp=NONE cterm=NONE gui=NONE
  hi CursorLineNr ctermfg=9 ctermbg=7 guifg=#d87b32 guibg=#f0f0f0 guisp=NONE cterm=NONE gui=NONE
  ...
  hi Terminal ctermfg=0 ctermbg=15 guifg=#5f5f61 guibg=#fafafa guisp=NONE cterm=NONE gui=NONE
endif
hi ColorColumn ctermfg=NONE ctermbg=7 guifg=NONE guibg=#f0f0f0 guisp=NONE cterm=NONE gui=NONE
hi Conceal ctermfg=2 ctermbg=NONE guifg=#00a7a0 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi Cursor ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi CursorColumn ctermfg=NONE ctermbg=7 guifg=NONE guibg=#f0f0f0 guisp=NONE cterm=NONE gui=NONE
hi DiffAdd ctermfg=10 ctermbg=fg guifg=#abb96e guibg=fg guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi DiffChange ctermfg=3 ctermbg=15 guifg=#e1ad0b guibg=#fafafa guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi DiffDelete ctermfg=1 ctermbg=15 guifg=#e8503f guibg=#fafafa guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi DiffText ctermfg=6 ctermbg=15 guifg=#1faed0 guibg=#fafafa guisp=NONE cterm=NONE,bold,reverse gui=NONE,bold,reverse
hi Directory ctermfg=2 ctermbg=NONE guifg=#00a7a0 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi EndOfBuffer ctermfg=9 ctermbg=NONE guifg=#d87b32 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi ErrorMsg ctermfg=1 ctermbg=15 guifg=#e8503f guibg=#fafafa guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi IncSearch ctermfg=9 ctermbg=15 guifg=#d87b32 guibg=#fafafa guisp=NONE cterm=NONE,reverse gui=NONE,standout
hi MatchParen ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=#5f5f61 cterm=NONE,bold,underline gui=NONE,bold,underline
hi ModeMsg ctermfg=fg ctermbg=NONE guifg=fg guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi MoreMsg ctermfg=9 ctermbg=NONE guifg=#d87b32 guibg=NONE guisp=NONE cterm=NONE gui=NONE
...
hi PmenuSbar ctermfg=9 ctermbg=8 guifg=#d87b32 guibg=#888888 guisp=NONE cterm=NONE gui=NONE
hi PmenuSel ctermfg=15 ctermbg=9 guifg=#fafafa guibg=#d87b32 guisp=NONE cterm=NONE gui=NONE
hi PmenuThumb ctermfg=1 ctermbg=9 guifg=#e8503f guibg=#d87b32 guisp=NONE cterm=NONE gui=NONE
hi Question ctermfg=fg ctermbg=NONE guifg=fg guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi! link QuickFixLine Search
hi Search ctermfg=11 ctermbg=15 guifg=#ebb822 guibg=#fafafa guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi SignColumn ctermfg=9 ctermbg=NONE guifg=#d87b32 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi SpecialKey ctermfg=9 ctermbg=NONE guifg=#d87b32 guibg=NONE guisp=NONE cterm=NONE gui=NONE
...
hi Title ctermfg=9 ctermbg=NONE guifg=#d87b32 guibg=NONE guisp=NONE cterm=NONE,bold gui=NONE,bold
hi Visual ctermfg=4 ctermbg=15 guifg=#4a8091 guibg=#fafafa guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi VisualNOS ctermfg=15 ctermbg=4 guifg=#fafafa guibg=#4a8091 guisp=NONE cterm=NONE gui=NONE
hi WarningMsg ctermfg=1 ctermbg=NONE guifg=#e8503f guibg=NONE guisp=NONE cterm=NONE gui=NONE
let s:fc = abs(get(g:, 'wwdc17_frame_color', 10)) % 16
if s:fc == 0
  hi StatusLine ctermfg=0 ctermbg=15 guifg=#5f5f61 guibg=#fafafa guisp=NONE cterm=NONE,bold,reverse gui=NONE,bold,reverse
  hi StatusLineNC ctermfg=0 ctermbg=7 guifg=#5f5f61 guibg=#f0f0f0 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi TabLine ctermfg=7 ctermbg=0 guifg=#f0f0f0 guibg=#5f5f61 guisp=NONE cterm=NONE gui=NONE
  hi TabLineFill ctermfg=15 ctermbg=0 guifg=#fafafa guibg=#5f5f61 guisp=NONE cterm=NONE gui=NONE
  hi TabLineSel ctermfg=15 ctermbg=0 guifg=#fafafa guibg=#5f5f61 guisp=NONE cterm=NONE,bold gui=NONE,bold
  hi VertSplit ctermfg=7 ctermbg=0 guifg=#f0f0f0 guibg=#5f5f61 guisp=NONE cterm=NONE gui=NONE
  hi WildMenu ctermfg=15 ctermbg=5 guifg=#fafafa guibg=#db2d45 guisp=NONE cterm=NONE,bold gui=NONE,bold
elseif s:fc == 1
  hi StatusLine ctermfg=1 ctermbg=15 guifg=#e8503f guibg=#fafafa guisp=NONE cterm=NONE,bold,reverse gui=NONE,bold,reverse
  ...
  hi TabLineFill ctermfg=15 ctermbg=1 guifg=#fafafa guibg=#e8503f guisp=NONE cterm=NONE gui=NONE
  hi TabLineSel ctermfg=15 ctermbg=9 guifg=#fafafa guibg=#d87b32 guisp=NONE cterm=NONE,bold gui=NONE,bold
  hi VertSplit ctermfg=7 ctermbg=1 guifg=#f0f0f0 guibg=#e8503f guisp=NONE cterm=NONE gui=NONE
  hi WildMenu ctermfg=15 ctermbg=10 guifg=#fafafa guibg=#abb96e guisp=NONE cterm=NONE,bold gui=NONE,bold
elseif s:fc == 2
  hi StatusLine ctermfg=2 ctermbg=15 guifg=#00a7a0 guibg=#fafafa guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi StatusLineNC ctermfg=2 ctermbg=4 guifg=#00a7a0 guibg=#4a8091 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi TabLine ctermfg=4 ctermbg=2 guifg=#4a8091 guibg=#00a7a0 guisp=NONE cterm=NONE gui=NONE
  hi TabLineFill ctermfg=15 ctermbg=2 guifg=#fafafa guibg=#00a7a0 guisp=NONE cterm=NONE gui=NONE
  hi TabLineSel ctermfg=15 ctermbg=2 guifg=#fafafa guibg=#00a7a0 guisp=NONE cterm=NONE gui=NONE
  hi VertSplit ctermfg=4 ctermbg=2 guifg=#4a8091 guibg=#00a7a0 guisp=NONE cterm=NONE gui=NONE
  hi WildMenu ctermfg=15 ctermbg=5 guifg=#fafafa guibg=#db2d45 guisp=NONE cterm=NONE gui=NONE
elseif s:fc == 3
  hi StatusLine ctermfg=3 ctermbg=15 guifg=#e1ad0b guibg=#fafafa guisp=NONE cterm=NONE,bold,reverse gui=NONE,bold,reverse
  hi StatusLineNC ctermfg=3 ctermbg=4 guifg=#e1ad0b guibg=#4a8091 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi TabLine ctermfg=4 ctermbg=3 guifg=#4a8091 guibg=#e1ad0b guisp=NONE cterm=NONE gui=NONE
  hi TabLineFill ctermfg=15 ctermbg=3 guifg=#fafafa guibg=#e1ad0b guisp=NONE cterm=NONE gui=NONE
  hi TabLineSel ctermfg=15 ctermbg=3 guifg=#fafafa guibg=#e1ad0b guisp=NONE cterm=NONE,bold gui=NONE,bold
  hi VertSplit ctermfg=4 ctermbg=3 guifg=#4a8091 guibg=#e1ad0b guisp=NONE cterm=NONE gui=NONE
  hi WildMenu ctermfg=15 ctermbg=5 guifg=#fafafa guibg=#db2d45 guisp=NONE cterm=NONE,bold gui=NONE,bold
elseif s:fc == 4
  hi StatusLine ctermfg=4 ctermbg=15 guifg=#4a8091 guibg=#fafafa guisp=NONE cterm=NONE,bold,reverse gui=NONE,bold,reverse
  hi StatusLineNC ctermfg=4 ctermbg=7 guifg=#4a8091 guibg=#f0f0f0 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi TabLine ctermfg=15 ctermbg=4 guifg=#fafafa guibg=#4a8091 guisp=NONE cterm=NONE gui=NONE
  hi TabLineFill ctermfg=15 ctermbg=4 guifg=#fafafa guibg=#4a8091 guisp=NONE cterm=NONE gui=NONE
  hi TabLineSel ctermfg=15 ctermbg=4 guifg=#fafafa guibg=#4a8091 guisp=NONE cterm=NONE,bold gui=NONE,bold
  hi VertSplit ctermfg=7 ctermbg=4 guifg=#f0f0f0 guibg=#4a8091 guisp=NONE cterm=NONE gui=NONE
  hi WildMenu ctermfg=15 ctermbg=5 guifg=#fafafa guibg=#db2d45 guisp=NONE cterm=NONE,bold gui=NONE,bold
elseif s:fc == 5
  hi StatusLine ctermfg=5 ctermbg=15 guifg=#db2d45 guibg=#fafafa guisp=NONE cterm=NONE,bold,reverse gui=NONE,bold,reverse
  ...
  hi TabLineSel ctermfg=15 ctermbg=5 guifg=#fafafa guibg=#db2d45 guisp=NONE cterm=NONE,bold gui=NONE,bold
  hi VertSplit ctermfg=7 ctermbg=5 guifg=#f0f0f0 guibg=#db2d45 guisp=NONE cterm=NONE gui=NONE
  hi WildMenu ctermfg=15 ctermbg=3 guifg=#fafafa guibg=#e1ad0b guisp=NONE cterm=NONE gui=NONE
elseif s:fc == 6
  hi StatusLine ctermfg=6 ctermbg=15 guifg=#1faed0 guibg=#fafafa guisp=NONE cterm=NONE,bold,reverse gui=NONE,bold,reverse
  ...
  hi TabLineFill ctermfg=15 ctermbg=6 guifg=#fafafa guibg=#1faed0 guisp=NONE cterm=NONE gui=NONE
  hi TabLineSel ctermfg=15 ctermbg=6 guifg=#fafafa guibg=#1faed0 guisp=NONE cterm=NONE,bold gui=NONE,bold
  hi VertSplit ctermfg=7 ctermbg=6 guifg=#f0f0f0 guibg=#1faed0 guisp=NONE cterm=NONE gui=NONE
  hi WildMenu ctermfg=15 ctermbg=5 guifg=#fafafa guibg=#db2d45 guisp=NONE cterm=NONE,bold gui=NONE,bold
elseif s:fc == 7
  hi StatusLine ctermfg=7 ctermbg=0 guifg=#f0f0f0 guibg=#5f5f61 guisp=NONE cterm=NONE,bold,reverse gui=NONE,bold,reverse
  ...
  hi TabLineFill ctermfg=0 ctermbg=7 guifg=#5f5f61 guibg=#f0f0f0 guisp=NONE cterm=NONE gui=NONE
  hi TabLineSel ctermfg=0 ctermbg=7 guifg=#5f5f61 guibg=#f0f0f0 guisp=NONE cterm=NONE,bold gui=NONE,bold
  hi VertSplit ctermfg=8 ctermbg=7 guifg=#888888 guibg=#f0f0f0 guisp=NONE cterm=NONE gui=NONE
  hi WildMenu ctermfg=15 ctermbg=5 guifg=#fafafa guibg=#db2d45 guisp=NONE cterm=NONE,bold gui=NONE,bold
elseif s:fc == 8
  hi StatusLine ctermfg=8 ctermbg=15 guifg=#888888 guibg=#fafafa guisp=NONE cterm=NONE,bold,reverse gui=NONE,bold,reverse
  ...
  hi TabLineFill ctermfg=15 ctermbg=8 guifg=#fafafa guibg=#888888 guisp=NONE cterm=NONE gui=NONE
  hi TabLineSel ctermfg=15 ctermbg=8 guifg=#fafafa guibg=#888888 guisp=NONE cterm=NONE,bold gui=NONE,bold
  hi VertSplit ctermfg=7 ctermbg=8 guifg=#f0f0f0 guibg=#888888 guisp=NONE cterm=NONE gui=NONE
  hi WildMenu ctermfg=15 ctermbg=5 guifg=#fafafa guibg=#db2d45 guisp=NONE cterm=NONE,bold gui=NONE,bold
elseif s:fc == 9
  hi StatusLine ctermfg=9 ctermbg=15 guifg=#d87b32 guibg=#fafafa guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi StatusLineNC ctermfg=9 ctermbg=4 guifg=#d87b32 guibg=#4a8091 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi TabLine ctermfg=4 ctermbg=9 guifg=#4a8091 guibg=#d87b32 guisp=NONE cterm=NONE gui=NONE
  hi TabLineFill ctermfg=15 ctermbg=9 guifg=#fafafa guibg=#d87b32 guisp=NONE cterm=NONE gui=NONE
  hi TabLineSel ctermfg=15 ctermbg=9 guifg=#fafafa guibg=#d87b32 guisp=NONE cterm=NONE gui=NONE
  hi VertSplit ctermfg=4 ctermbg=9 guifg=#4a8091 guibg=#d87b32 guisp=NONE cterm=NONE gui=NONE
  hi WildMenu ctermfg=15 ctermbg=10 guifg=#fafafa guibg=#abb96e guisp=NONE cterm=NONE gui=NONE
elseif s:fc == 10
  hi StatusLine ctermfg=10 ctermbg=15 guifg=#abb96e guibg=#fafafa guisp=NONE cterm=NONE,bold,reverse gui=NONE,bold,reverse
  hi StatusLineNC ctermfg=10 ctermbg=0 guifg=#abb96e guibg=#5f5f61 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi TabLine ctermfg=0 ctermbg=10 guifg=#5f5f61 guibg=#abb96e guisp=NONE cterm=NONE gui=NONE
  hi TabLineFill ctermfg=15 ctermbg=10 guifg=#fafafa guibg=#abb96e guisp=NONE cterm=NONE gui=NONE
  hi TabLineSel ctermfg=15 ctermbg=10 guifg=#fafafa guibg=#abb96e guisp=NONE cterm=NONE,bold gui=NONE,bold
  hi VertSplit ctermfg=0 ctermbg=10 guifg=#5f5f61 guibg=#abb96e guisp=NONE cterm=NONE gui=NONE
  hi WildMenu ctermfg=15 ctermbg=5 guifg=#fafafa guibg=#db2d45 guisp=NONE cterm=NONE gui=NONE
elseif s:fc == 11
  hi StatusLine ctermfg=11 ctermbg=15 guifg=#ebb822 guibg=#fafafa guisp=NONE cterm=NONE,bold,reverse gui=NONE,bold,reverse
  hi StatusLineNC ctermfg=11 ctermbg=4 guifg=#ebb822 guibg=#4a8091 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi TabLine ctermfg=4 ctermbg=11 guifg=#4a8091 guibg=#ebb822 guisp=NONE cterm=NONE gui=NONE
  hi TabLineFill ctermfg=15 ctermbg=11 guifg=#fafafa guibg=#ebb822 guisp=NONE cterm=NONE gui=NONE
  hi TabLineSel ctermfg=15 ctermbg=11 guifg=#fafafa guibg=#ebb822 guisp=NONE cterm=NONE,bold gui=NONE,bold
  hi VertSplit ctermfg=4 ctermbg=11 guifg=#4a8091 guibg=#ebb822 guisp=NONE cterm=NONE gui=NONE
  hi WildMenu ctermfg=15 ctermbg=5 guifg=#fafafa guibg=#db2d45 guisp=NONE cterm=NONE,bold gui=NONE,bold
elseif s:fc == 12
  hi StatusLine ctermfg=12 ctermbg=15 guifg=#8c61a6 guibg=#fafafa guisp=NONE cterm=NONE,bold,reverse gui=NONE,bold,reverse
  ...
  hi TabLineFill ctermfg=15 ctermbg=12 guifg=#fafafa guibg=#8c61a6 guisp=NONE cterm=NONE gui=NONE
  hi TabLineSel ctermfg=15 ctermbg=12 guifg=#fafafa guibg=#8c61a6 guisp=NONE cterm=NONE,bold gui=NONE,bold
  hi VertSplit ctermfg=7 ctermbg=12 guifg=#f0f0f0 guibg=#8c61a6 guisp=NONE cterm=NONE gui=NONE
  hi WildMenu ctermfg=15 ctermbg=5 guifg=#fafafa guibg=#db2d45 guisp=NONE cterm=NONE,bold gui=NONE,bold
elseif s:fc == 13
  hi StatusLine ctermfg=13 ctermbg=15 guifg=#eb314b guibg=#fafafa guisp=NONE cterm=NONE,bold,reverse gui=NONE,bold,reverse
  ...
  hi TabLineSel ctermfg=15 ctermbg=13 guifg=#fafafa guibg=#eb314b guisp=NONE cterm=NONE,bold gui=NONE,bold
  hi VertSplit ctermfg=7 ctermbg=13 guifg=#f0f0f0 guibg=#eb314b guisp=NONE cterm=NONE gui=NONE
  hi WildMenu ctermfg=15 ctermbg=3 guifg=#fafafa guibg=#e1ad0b guisp=NONE cterm=NONE gui=NONE
elseif s:fc == 14
  hi StatusLine ctermfg=14 ctermbg=15 guifg=#23bce1 guibg=#fafafa guisp=NONE cterm=NONE,bold,reverse gui=NONE,bold,reverse
  ...
  hi TabLineFill ctermfg=15 ctermbg=14 guifg=#fafafa guibg=#23bce1 guisp=NONE cterm=NONE gui=NONE
  hi TabLineSel ctermfg=15 ctermbg=14 guifg=#fafafa guibg=#23bce1 guisp=NONE cterm=NONE,bold gui=NONE,bold
  hi VertSplit ctermfg=7 ctermbg=14 guifg=#f0f0f0 guibg=#23bce1 guisp=NONE cterm=NONE gui=NONE
  hi WildMenu ctermfg=15 ctermbg=5 guifg=#fafafa guibg=#db2d45 guisp=NONE cterm=NONE,bold gui=NONE,bold
elseif s:fc == 15
  hi StatusLine ctermfg=15 ctermbg=0 guifg=#fafafa guibg=#5f5f61 guisp=NONE cterm=NONE,bold,reverse gui=NONE,bold,reverse
  hi StatusLineNC ctermfg=15 ctermbg=8 guifg=#fafafa guibg=#888888 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi TabLine ctermfg=8 ctermbg=15 guifg=#888888 guibg=#fafafa guisp=NONE cterm=NONE gui=NONE
  hi TabLineFill ctermfg=8 ctermbg=15 guifg=#888888 guibg=#fafafa guisp=NONE cterm=NONE gui=NONE
  hi TabLineSel ctermfg=0 ctermbg=15 guifg=#5f5f61 guibg=#fafafa guisp=NONE cterm=NONE,bold gui=NONE,bold
  hi VertSplit ctermfg=8 ctermbg=15 guifg=#888888 guibg=#fafafa guisp=NONE cterm=NONE gui=NONE
  hi WildMenu ctermfg=15 ctermbg=8 guifg=#fafafa guibg=#888888 guisp=NONE cterm=NONE gui=NONE
endif
unlet s:fc
hi! link StatusLineTerm StatusLine
hi! link StatusLineTermNC StatusLineNC
hi Boolean ctermfg=10 ctermbg=NONE guifg=#abb96e guibg=NONE guisp=NONE cterm=NONE gui=NONE
...
hi! link Conditional Statement
hi Constant ctermfg=2 ctermbg=NONE guifg=#00a7a0 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi! link Define PreProc
hi Debug ctermfg=5 ctermbg=NONE guifg=#db2d45 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi Delimiter ctermfg=4 ctermbg=NONE guifg=#4a8091 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi Error ctermfg=1 ctermbg=15 guifg=#e8503f guibg=#fafafa guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi! link Exception Statement
hi Float ctermfg=10 ctermbg=NONE guifg=#abb96e guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi Function ctermfg=2 ctermbg=NONE guifg=#00a7a0 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi Identifier ctermfg=4 ctermbg=NONE guifg=#4a8091 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi Ignore ctermfg=15 ctermbg=NONE guifg=#fafafa guibg=NONE guisp=NONE cterm=NONE gui=NONE
...
hi Label ctermfg=2 ctermbg=NONE guifg=#00a7a0 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi! link Macro PreProc
hi Number ctermfg=2 ctermbg=NONE guifg=#00a7a0 guibg=NONE guisp=NONE cterm=NONE gui=NONE
...
hi String ctermfg=9 ctermbg=NONE guifg=#d87b32 guibg=NONE guisp=NONE cterm=NONE gui=NONE
...
hi Underlined ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=NONE cterm=NONE,underline gui=NONE,underline
hi! link lCursor Cursor
hi CursorIM ctermfg=NONE ctermbg=15 guifg=NONE guibg=#fafafa guisp=NONE cterm=NONE gui=NONE
hi ToolbarLine ctermfg=8 ctermbg=7 guifg=#888888 guibg=#f0f0f0 guisp=NONE cterm=NONE gui=NONE
hi ToolbarButton ctermfg=0 ctermbg=7 guifg=#5f5f61 guibg=#f0f0f0 guisp=NONE cterm=NONE,bold gui=NONE,bold
hi NormalMode ctermfg=8 ctermbg=15 guifg=#888888 guibg=#fafafa guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi InsertMode ctermfg=10 ctermbg=15 guifg=#abb96e guibg=#fafafa guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi ReplaceMode ctermfg=9 ctermbg=15 guifg=#d87b32 guibg=#fafafa guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi VisualMode ctermfg=4 ctermbg=15 guifg=#4a8091 guibg=#fafafa guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi CommandMode ctermfg=5 ctermbg=15 guifg=#db2d45 guibg=#fafafa guisp=NONE cterm=NONE,reverse gui=NONE,reverse
if has('nvim')
  hi! link TermCursor Cursor
  hi TermCursorNC ctermfg=15 ctermbg=0 guifg=#fafafa guibg=#5f5f61 guisp=NONE cterm=NONE gui=NONE
  let g:terminal_color_0='#5f5f61'
  let g:terminal_color_1='#e8503f'
  let g:terminal_color_2='#00a7a0'
  let g:terminal_color_3='#e1ad0b'
