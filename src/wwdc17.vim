...
call s:hl (     "Normal",       s:ashgrey,    s:none,       {'indent': 4})
call s:hl (     "LineNr",       s:grey,       s:none,       {'indent': 4})
call s:hl (     "CursorLineNr", s:magenta,    s:none,       {'indent': 4})
call s:hl (     "CursorLine",   s:none,       s:none,       {'indent': 4, 'cterm': 'NONE,underline'})
call s:hl (     "Folded",       s:grey,       s:none,       {'indent': 4, 'gui': 'NONE,italic'})
call s:put("  else")
call s:hl (     "Normal",       s:ashgrey,    s:bwhite,     {'indent': 4})
call s:hl (     "LineNr",       s:grey,       s:vlightgrey, {'indent': 4})
call s:hl (     "CursorLineNr", s:magenta,    s:vlightgrey, {'indent': 4})
call s:hl (     "CursorLine",   s:none,       s:vlightgrey, {'indent': 4})
call s:hl (     "Folded",       s:grey,       s:vlightgrey, {'indent': 4, 'gui': 'NONE,italic'})
call s:put("  endif")
call s:hl (  "FoldColumn",      s:grey,        s:none,      {'indent': 2})
call s:put("else")
call s:put("  if !has('gui_running') && get(g:, 'wwdc17_term_trans_bg', 0)")
call s:hl (     "Normal",       s:fg,         s:none,       {'indent': 4})
call s:hl (     "LineNr",       s:lightgrey,  s:none,       {'indent': 4})
call s:hl (     "CursorLineNr", s:orange,     s:none,       {'indent': 4})
call s:hl (     "CursorLine",   s:none,       s:none,       {'indent': 4, 'cterm': 'NONE,underline'})
call s:hl (     "Folded",       s:grey,       s:none,       {'indent': 4, 'gui': 'NONE,italic'})
call s:put("  else")
call s:hl (     "Normal",       s:fg,         s:bg,         {'indent': 4})
call s:hl (     "LineNr",       s:grey,       s:vlightgrey, {'indent': 4})
call s:hl (     "CursorLineNr", s:orange,     s:vlightgrey, {'indent': 4})
call s:hl (     "CursorLine",   s:none,       s:vlightgrey, {'indent': 4})
call s:hl (     "Folded",       s:grey,       s:vlightgrey, {'indent': 4, 'gui': 'NONE,italic'})
call s:put("  endif")
call s:hl (  "FoldColumn",      s:lightgrey,  s:none,       {'indent': 2})
call s:put("endif")
call s:put("")
...
call s:hl("NonText",             s:lightgrey,  s:none)
...
call s:hl("SpellBad",            s:magenta,    s:none,       {'cterm':  'NONE,underline',    'gui': 'NONE,undercurl',    'guisp':  s:lightgrey[0]})
call s:hl("SpellCap",            s:magenta,    s:none,       {'cterm':  'NONE,underline',    'gui': 'NONE,undercurl',    'guisp':  s:lightgrey[0]})
call s:hl("SpellLocal",          s:magenta,    s:none,       {'cterm':  'NONE,underline',    'gui': 'NONE,undercurl',    'guisp':  s:lightgrey[0]})
call s:hl("SpellRare",           s:magenta,    s:none,       {'cterm':  'NONE,underline',    'gui': 'NONE,undercurl',    'guisp':  s:lightgrey[0]})
...
call s:hl("WildMenu",            s:bg,         s:lemongreen, {'indent': 2})
...
call s:hl("TabLineFill",         s:white,      s:aqua,       {'indent': 2})
...
call s:hl("TabLineFill",         s:white,      s:yellow,     {'indent': 2})
...
call s:hl("TabLineFill",         s:white,      s:blue,       {'indent': 2})
...
call s:hl("TabLineFill",         s:white,      s:teal,       {'indent': 2})
...
call s:hl("TabLineFill",         s:white,      s:ashgrey,    {'indent': 2})
...
call s:hl("TabLineFill",         s:white,      s:orange,     {'indent': 2})
call s:hl("TabLineSel",          s:white,      s:orange,     {'indent': 2})
...
call s:hl("TabLineFill",         s:white,      s:lemongreen, {'indent': 2})
...
call s:hl("TabLineFill",         s:white,      s:lightgrey,  {'indent': 2})
...
call s:hl("StatusLine",          s:purple,     s:bwhite,     {'indent': 2, 'cterm': 'NONE,bold,reverse', 'gui': 'NONE,bold,reverse'})
call s:hl("StatusLineNC",        s:purple,     s:vlightgrey, {'indent': 2, 'cterm': 'NONE,reverse',      'gui': 'NONE,reverse'})
call s:hl("TabLine",             s:vlightgrey, s:purple,     {'indent': 2})
call s:hl("TabLineFill",         s:bwhite,     s:purple,     {'indent': 2})
call s:hl("TabLineSel",          s:bwhite,     s:purple,     {'indent': 2, 'cterm': 'NONE,bold', 'gui': 'NONE,bold'})
...
call s:hl("TabLineFill",         s:white,      s:grey,       {'indent': 2})
...
call s:hl("TabLineFill",         s:black,      s:vlightgrey, {'indent': 2})
call s:hl("TabLineSel",          s:black,      s:vlightgrey, {'cterm':  'NONE,bold',         'gui': 'NONE,bold',         'indent': 2})
...
call s:hl("TabLineFill",         s:black,      s:bwhite,     {'indent': 2})
...
call s:hl("Number",              s:aqua,       s:none)
