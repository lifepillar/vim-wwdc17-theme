...
let s:brightyellow  = [s:rgb2hex(225, 173, 11),  11]
let s:brightblue    = [s:rgb2hex(140, 97,  166), 12]
let s:brightmagenta = [s:rgb2hex(219, 45,  69),  13]
let s:brightcyan    = [s:rgb2hex(31,  174, 208), 14]
...
call s:hl (   "LineNr",       s:brightblack, s:none, {'indent': 4})
call s:hl (   "CursorLineNr", s:brightred,   s:none, {'indent': 4})
call s:hl (   "CursorLine",   s:none,        s:none, {'indent': 4, 'cterm': 'NONE,underline'})
call s:hl (   "Folded",       s:brightblack, s:none, {'indent': 4, 'gui'  : 'NONE,italic'})
call s:put("else")
call s:hl (   "Normal",       s:fg,          s:bg,    {'indent': 4})
call s:hl (   "LineNr",       s:brightblack, s:white, {'indent': 4})
call s:hl (   "CursorLineNr", s:brightred,   s:white, {'indent': 4})
call s:hl (   "CursorLine",   s:none,        s:white, {'indent': 4})
call s:hl (   "Folded",       s:brightblack, s:white, {'indent': 4, 'gui' : 'NONE,italic'})
call s:put("endif")
call s:hl (  "FoldColumn",    s:brightblack, s:none,  {'indent': 2})
call s:put("")
